 ...
 */
public class EffetBuffValAttaque extends sandarena.partie.jeu.compcase.effet.effetbuff.EffetBuffVal {
    public EffetBuffValAttaque(String nom,int val, sandarena.partie.jeu.compcase.effet.EffetBufGroup group) {
        super(nom,val, group);
    }

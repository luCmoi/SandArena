 ...
 */
class CompPanelScreenPrepaListener extends InputListener {
    private CompPanelScreenPrepaMatch container;
    private boolean pression;
    private long time;

    public CompPanelScreenPrepaListener(CompPanelScreenPrepaMatch competence) {

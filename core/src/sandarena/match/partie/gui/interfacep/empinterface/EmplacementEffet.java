...
public class EmplacementEffet extends EmplacementInterface {
    ...
    public void setEffet(sandarena.match.partie.jeu.compcase.PersonnageIG perso) {
    ...
    public ArrayList<sandarena.match.partie.jeu.compcase.effet.EffetBuf> getEffets() {
        return effets;
    }

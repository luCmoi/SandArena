 ...
 */
public class Defaite extends Group {
    private SurcouchePartie container;
    private BouttonConfirme bouton;

    public Defaite(SurcouchePartie surcouche) {
        super();
        container = surcouche;
    ...
    public void draw(Batch batch, float parentAlpha) {
        if (isVisible()) {
            ...
            Font.font.draw(batch, "Defaite !", getX() + (getWidth() / 2) - (Font.font.getSpaceWidth() *9 / 2), getY() + getHeight() - getHeight() / 8);

...
import sandarena.preparematch.barre.*;
...
public class EmplacementBarre extends Group {
    ...
    private sandarena.preparematch.barre.emplacement.AccepteBarre accepte;
    ...
    public EmplacementBarre(StageBarre container, int place, Personnage perso) {
        ...
        accepte = new sandarena.preparematch.barre.emplacement.AccepteBarre(this);

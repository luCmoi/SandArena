 ...
 */
public class EmplacementBlessureListener extends InputListener {
    private EmplacementBlessure container;
    private boolean pression;
    private long time;

    public EmplacementBlessureListener(EmplacementBlessure competence) {
